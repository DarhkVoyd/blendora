...
interface CustomMetadataSection {
  sectionId: string
  sectionClass?: string
  headerIcon?: string
  headerTitle?: string
...
export const createPanelHeader = (customHeader: CustomPanelHeader): HTMLDivElement => {
...
export const createMenuItem = (customMenuItem: CustomMenuItem): HTMLDivElement => {
...
export const createMetadataSection = (customMetadataSection: CustomMetadataSection): HTMLDivElement => {
...
export const createSectionItem = (customSectionItem: CustomSectionItem): HTMLDivElement => {
